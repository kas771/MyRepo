...
my_proc.set_ana_output_file("LeslieSampleAna_output_anafile.root")

# Attach an analysis unit ... here we use a base class which does nothing.
# Replace with your analysis unit if you wish.
mylesliemodule = fmwk.LeslieSampleAna()
# This is a public function I implemented in LeslieSampleAna.h
mylesliemodule.SetDebugFlag(False)
my_proc.add_process(mylesliemodule)
